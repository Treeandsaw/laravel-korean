...
class PostController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $avata = $user->avatar;
        $replies = Reply::all();
        isset(Auth::user()->name) ? $who = Auth::user()->name : $who = 'unknown';
        return view('posts.show')->with('post', $post)->with('who', $who)->with('auth', $auth)->with('avata', $avata)->with('replies', $replies);
    }
